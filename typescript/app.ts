...
/*
let mensagem:string = "Seja bem vendo !!"
...
/*
    exemplos basico de tipagem no typescript

    para rodar a transformação de ts para es5 utlizar
    comando tsc -w no promt no diretorio que esta sendo utlizado
*/